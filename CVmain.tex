...
% 自定义颜色（参考 ）
\definecolor{primary_color}{RGB}{0, 109, 184} % 地大蓝
\definecolor{secondary_color}{RGB}{153, 122, 92} % 地质褐
...
\begin{document}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        % 教育背景
        \begin{minipage}[t]{\textwidth}
        \section[教育背景]{\makebox[\iconwidth][c]{\color{primary_color}{\faLandmark}}\quad 教育背景}
    ...
    \section[项目经历]{\makebox[\iconwidth][c]{\color{primary_color}{\faUsersCog}}\quad 项目经历}
    ...
    \begin{minipage}[t]{0.6\textwidth}
        \section[技能特长]{\makebox[\iconwidth][c]{\color{primary_color}{\faLaptopCode}}\quad 技能特长}
        \begin{itemize}
    ...
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
        \section[兴趣爱好]{\makebox[\iconwidth][c]{\color{primary_color}{\faPalette}}\quad 兴趣爱好}
        \begin{itemize}
        \setlength{\itemsep}{0.5em}
            \item 上天
            \item 入地
